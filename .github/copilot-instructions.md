...
- Integration tests around `runtime`, persisted pipeline flow, worker dispatch, and `runs` CLI behavior are the main executable proof of current runtime behavior.
