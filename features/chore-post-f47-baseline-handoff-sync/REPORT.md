...
- `README.md` atualizado para documentar `synapse auth init|issue --role ...` e as roles `viewer`, `operator`, `admin`
...
- `env UV_CACHE_DIR=/home/g0dsssp33d/work/projects/synapse-os/.cache/uv uv run --no-sync python - <<'PY' ... validate_spec_file(Path('features/chore-post-f47-baseline-handoff-sync/SPEC.md')) ... PY`
...
- `env UV_CACHE_DIR=/home/g0dsssp33d/work/projects/synapse-os/.cache/uv ./scripts/commit-check.sh --no-sync --skip-branch-validation --skip-docker --skip-security`
