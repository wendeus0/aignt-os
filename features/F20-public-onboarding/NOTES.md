...
- A mitigacao do risco residual da F19 entra na F20 pelo eixo de onboarding: explicitar o que `aignt doctor` garante e o que continua pertencendo ao `repo-preflight`.
