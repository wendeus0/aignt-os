...
- O worker agora filtra runs pendentes compatíveis com `started_by` quando o runtime autenticado está ativo, mantendo o AIgnt-Synapse-Flow como a engine propria de pipeline do AIgnt OS.
