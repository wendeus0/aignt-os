...
- O foco e tornar consultavel, de forma humana, o que o AIgnt-Synapse-Flow ja persiste como engine propria de pipeline do AIgnt OS.
- O recorte recomendado e pequeno: `aignt runs list` e `aignt runs show <run_id>`.
